# From http://code.google.com/p/ebcode/
# LICENSE — This code is Copyright 2007-2009 EveryBlock LLC and is made available
# to you under the GNU General Public License (GPL) version 3. To paraphrase, this
# means that if you distribute any changes, you must make them available under the
# same open-source license. Our documentation is licensed separately, under the
# Creative Commons Attribution-Share Alike 3.0 United States License. The Knight
# Foundation folks have requested we use these licenses.
